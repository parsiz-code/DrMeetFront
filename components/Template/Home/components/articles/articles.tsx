...
function Articles() {
  return (
    <div>
      <Grid container className="w-full px-16 py-10">
        <Grid item xs={12} className="mb-10">
          <h1 className="text-center text-[1.5rem] font-bold">مقالات</h1>
        </Grid>
        <Grid item xs={12}>
          <Swiper slidesPerView={3} className="flex justify-center items-center w-full">
            <SwiperSlide className="p-4">
              <Card className="shadow rounded-2xl">
                ...
                <CardActions className="flex justify-end px-4">
                  <Link href="#" className="text-black text-[1rem] hover:text-[#007dfe] hover:underline">مشاهده</Link>
                </CardActions>
              </Card>
            </SwiperSlide>
            <SwiperSlide className="p-4">
